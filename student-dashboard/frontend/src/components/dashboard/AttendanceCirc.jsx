...
const AttendanceCirc = ({ attendance }) => {
  ...
  return (
    <div className="card flex flex-col items-center justify-center">
      <h3 className="text-lg font-semibold text-slate-800 self-start mb-4">Overall Attendance</h3>
      ...
      <div className="mt-6 flex justify-between w-full text-sm">
        <div className="text-center">
          <p className="text-slate-500 font-medium">Conducted</p>
          <p className="font-bold text-slate-800">{total}</p>
        </div>
        <div className="text-center">
          <p className="text-slate-500 font-medium">Attended</p>
          <p className="font-bold text-slate-800">{attended}</p>
        </div>
      </div>
    </div>
  );
